...
extern double *d_pipe_torque_accum_x;
extern double *d_pipe_torque_accum_y;
extern double *d_pipe_torque_accum_z;
...
extern double *d_pipe_theta_x, *d_pipe_theta_y, *d_pipe_theta_z;
extern double *d_pipe_force_x, *d_pipe_force_y, *d_pipe_force_z;
extern double *d_pipe_torque_x, *d_pipe_torque_y, *d_pipe_torque_z;
...
extern double *h_pipe_theta_x, *h_pipe_theta_y, *h_pipe_theta_z;
extern double *h_pipe_force_x, *h_pipe_force_y, *h_pipe_force_z;
extern double *h_pipe_torque_x, *h_pipe_torque_y, *h_pipe_torque_z;
extern double *h_pipe_temp, *h_pipe_heat;
extern double *h_pipe_heat_x, *h_pipe_heat_y, *h_pipe_heat_z;
extern int *h_pipe_bnode;
extern int *h_pipe_bnode_owner;
extern int *h_new_fluid_nodes, *h_new_fluid_pids;
extern double *h_pipe_force_accum_x;
extern double *h_pipe_force_accum_y;
extern double *h_pipe_force_accum_z;
extern double *h_pipe_torque_accum_x;
extern double *h_pipe_torque_accum_y;
extern double *h_pipe_torque_accum_z;
